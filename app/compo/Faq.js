...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    { q: "Do you integrate payment gateways?", a: "Absolutely! We integrate Stripe, PayPal, Firebase Auth, and other third-party APIs as needed.", icon: <CreditCard size={22} className="text-indigo-400" /> },
